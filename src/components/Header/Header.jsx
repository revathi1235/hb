  ...
  return (
    <div className='header'>
...

        {
            type !== "list" &&
            <>
             <h1 className="headerTitle">Are you Looking for Discounts ? Come lets see</h1>
       <p className="headerDescription">Get Rewards fr your Happiness-Unlock with instant Savings upto 10%</p>
       ...
       <div className="headerSearchItem">
        ...
        {/* <div className="headerSearchItem">
            ...
            <span className='headerSearchText'> date to checkout</span>
        ...
        <div className="headerSearchItem">
            ...
            <span onClick={()=>setOpenOptions(!openOptions)} className='headerSearchText'>{`${options.adult} adult . ${options.children }children .${options.room} rom`} </span>
